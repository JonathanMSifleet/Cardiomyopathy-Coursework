...
export default {
  name: "Home",
  components: { HomeComponent, PageWrapper, NewsFeed },
  setup() {
    ...
    return {
      Welcome: {
        title: "HCM Research",
        description:
          "This website is a central repository for experimental data on force/tension development " +
      ...
      HCM: [
        {
          ...
          description:
            "In hypertrophic cardiomyopathy, the heart muscle cells enlarge " +
