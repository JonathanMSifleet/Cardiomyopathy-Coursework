...
const routes = [{
    ...
    },
    {
        ...
        base: '/',
        component: () =>
            import ('../views/PassReset/PassReset.vue'),
        beforeEnter: requireSignedOut
    },
    {
        path: '/login',
    ...
    },
    {
        ...
        component: () =>
            import ('../views/ExperimentalData/ExperimentalData.vue')
    },
    {
        path: '/profile',
        name: 'UserProfile',
        component: () =>
            import ('../views/UserProfile/UserProfile.vue')
    },
    // no route, route:
    {
        path: '/:pathMatch(.*)*',
