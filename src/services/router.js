...
},
{
  ...
  path: '/reset',
  base: '/',
  component: () => import (/* webpackChunkName: "PasswordReset" */ '../views/PassReset/PassReset.vue'),
  beforeEnter: requireSignedOut
},
{
  path: '/login',
...
},
{
  ...
  component: () => import (/* webpackChunkName: "ExperimentalData" */ '../views/ExperimentalData/ExperimentalData.vue')
},
{
  path: '/profile',
  name: 'UserProfile',
  component: () => import (/* webpackChunkName: "Profile" */ '../views/UserProfile/UserProfile.vue')
},
// no route, route:
{
  path: '/:pathMatch(.*)*',
